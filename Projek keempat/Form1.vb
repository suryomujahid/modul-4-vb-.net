Public Class Form1
   ...
   ByVal e As System.EventArgs) Handles Button3.Click
        sqlnya = "UPDATE tb_kamar set nama_kamar='" & TextBox2.Text & "',fasilitas='" & TextBox3.Text & "', fungsi='" & TextBox4.Text & "',tarif='" & TextBox5.Text & "',penanggung_jawab='" & TextBox6.Text & "' where kode_kamar='" &
        TextBox1.Text & "'"
        Call jalan()
    ...
    Private Sub Button2_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        sqlnya = "delete from tb_kamar where kode_kamar='" &
        TextBox1.Text & "'"
        Call jalan()
    ...
    Private Sub TextBox7_OnValueChanged(sender As Object, e As EventArgs) Handles TextBox7.OnValueChanged
        konek()
